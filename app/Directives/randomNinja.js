...
(function (App) {
    var Directives;
    (function (Directives) {
        var RandomNinjaDirective = /** @class */ (function () {
            function RandomNinjaDirective() {
                return {
                    restrict: 'E',
                    scope: {
                        ninjas: '=',
            ...
            return RandomNinjaDirective;
        }());
        Directives.RandomNinjaDirective = RandomNinjaDirective;
...
//# sourceMappingURL=../source-maps/Directives/randomNinja.js.map
